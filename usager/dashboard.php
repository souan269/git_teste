...
<head>
    ...
    <title>Usager - Bibliothèque Universitaire</title>
    <style>
        ...
        h1 { color: #1a3c5a; }
        .user-info { background: #e8f5e9; padding: 15px; border-radius: 8px; margin: 15px 0; }
...
<body>
    <div class="container">
        ...
        <p>✅ Vous êtes connecté en tant qu'usager. Vous pouvez consulter le catalogue et vos emprunts.</p>
